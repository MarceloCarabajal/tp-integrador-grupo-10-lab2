...
private:
    ...
    /**
     * @brief Obtener el número de turnos vencidos.
     * Calcula y devuelve la cantidad de turnos vencidos que han vencido hasta la
     * fecha actual.
     * @return El número de turnos vencido, o -1 si hay un error o no hay turnos 
     * registrados..
     */
    int getExpiredApps();

    /**
     * @brief Eliminar turnos vencidos.
     * Busca y elimina todos los turnos que han vencido hasta la fecha
