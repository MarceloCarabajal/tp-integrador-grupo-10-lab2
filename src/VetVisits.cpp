...
VetVisits::VetVisits (int visitid, int vetid, int clientid, int petid, int saleid, Date date,std::string reason, std::string diagnosis,bool status ){
_visitId=visitid;
_vetId=vetid;
_clientId=clientid;
_petId=petid;
...
void VetVisits::setStatus(bool status) { _status = status; }
...
bool VetVisits::getStatus() { return _status; }
